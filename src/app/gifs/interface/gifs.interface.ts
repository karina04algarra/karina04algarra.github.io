// To parse this data:
//
//   import { Convert, SearchGiftsResponse } from "./file";
//
//   const searchGiftsResponse = Convert.toSearchGiftsResponse(json);
//
...
export class Convert {
    public static toSearchGiftsResponse(json: string): SearchGiftsResponse {
        return cast(JSON.parse(json), r("SearchGiftsResponse"));
    }

    public static searchGiftsResponseToJson(value: SearchGiftsResponse): string {
        return JSON.stringify(uncast(value, r("SearchGiftsResponse")), null, 2);
    }
}
